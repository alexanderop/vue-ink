...
import { provideBackgroundColor, useBackgroundColor } from "./background-context.ts";
...
const Box = defineComponent({
  ...
  setup(props, { slots, expose }) {
    ...
    const parentBackground = useBackgroundColor();
    const isScreenReaderEnabled = useScreenReader();
    provideBackgroundColor(() => props.backgroundColor ?? parentBackground?.());
