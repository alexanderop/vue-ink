		...
		nav: [
			...
			{ text: 'Parity', link: '/reference/ink-parity' },
			{
				...
				items: [
					...
					{ text: '@vue-ink/components', link: 'https://www.npmjs.com/package/@vue-ink/components' },
					...
					{ text: '@vue-ink/testing-library', link: 'https://www.npmjs.com/package/@vue-ink/testing-library' },
				],
			},
		],
		sidebar: {
			...
			'/reference/': [
				{
					text: 'Reference',
					items: [
						{ text: 'Ink → vue-ink parity', link: '/reference/ink-parity' },
					],
				},
			],
		},
		socialLinks: [
			{ icon: 'github', link: 'https://github.com/alexanderop/vue-ink' },
		],
		editLink: {
