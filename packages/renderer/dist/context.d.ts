...
export declare const APP_CONTEXT_KEY: InjectionKey<AppContext>;
export declare const STDIN_CONTEXT_KEY: InjectionKey<StdinContext>;
export declare const STDOUT_CONTEXT_KEY: InjectionKey<StdoutContext>;
export declare const STDERR_CONTEXT_KEY: InjectionKey<StderrContext>;
export declare const ACCESSIBILITY_CONTEXT_KEY: InjectionKey<AccessibilityContext>;
export declare const FOCUS_CONTEXT_KEY: InjectionKey<FocusContext>;
export declare const ANIMATION_CONTEXT_KEY: InjectionKey<AnimationContext>;
export declare const CURSOR_CONTEXT_KEY: InjectionKey<CursorContext>;
