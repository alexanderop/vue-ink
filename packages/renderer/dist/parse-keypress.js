...
export const nonAlphanumericKeys = new Set([
    ...Object.values(keyName),
    'backspace',
]);
const isShiftKey = (code) => ['[a', '[b', '[c', '[d', '[e',
    '[2$', '[3$', '[5$', '[6$', '[7$', '[8$', '[Z'].includes(code);
const isCtrlKey = (code) => ['Oa', 'Ob', 'Oc', 'Od', 'Oe',
...
const parseKittyModifiers = (modifiers) => ({
